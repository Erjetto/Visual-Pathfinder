...
var ChangeState = {
    create: function(changes = {}){
        return {executedLine: this, ...changes}
    }
}
    ...
    lines: [
        { // Line index is defined automatically, scope is undefined or []
            ...
            execute: function(calculator){
                ...
                return ChangeState.create({explanation})
            },
        ...
        },
        {
            ...
            execute: function(calculator){
                ...
                let explanation = this.explanation(calculator)
                return ChangeState.create({addedCommands, explanation})
            },
            undo: function(calculator, change){
            ...
            scope: [
                ...
                },
                {
                    ...
                    getNumberString: (calculator) => {
                        switch(calculator.algoInfo['loopNeighbourIndex']){
                            ...
                            case 2: return '2nd'
                            case 3: return '3rd'
                            default: return calculator.algoInfo['loopNeighbourIndex'] + 'th'
                        }
                    },                 
                    execute: function(calculator){
                        ...
                        let explanation = this.explanation(calculator)
                        return ChangeState.create({explanation, prevIdx, addedCommands})
                    },
                    undo: function(calculator, change){
                ...
                },
                {
                    ...
                    execute: function(calculator){
                        ...
                        let prevIndexes = []
                        calculator.queue.forEach(e => {
                            prevIndexes.concat.push(prevArr.indexOf(e))
                        });
                        
                        let explanation = this.explanation(calculator)
                        return ChangeState.create({explanation, prevIndexes})
                    },
                    undo: function(calculator, change){
